...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch onOffSwitch = (Switch) findViewById(R.id.startStopSwitch);//declared the switch here pointing to id onOffSwitch
        myCounter = (TextView) findViewById(R.id.counter);
        myFrequency = (TextView) findViewById(R.id.slider1);
